...
<?php require('_includes/first-visit-message.php'); ?>
	<div id="cv">
		...
		<div id="cover-body">
			...
			<p class="body-copy">In full discolsure, this snazzy presentation is deliberately intended as a decoy. It aims to spotlight the pride I invest in my work while gracefully masking a dearth of traditional résumé fodder.</p>
