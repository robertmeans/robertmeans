...
<body>
	<div id="cv">
		...
		<div id="cover-body">
			...
			<p class="body-copy">Now that we're off to an honest start, I am wide open to entertaining virtually <i>any</i> business ideas. Please do not let a history of Web development typecast my skill set. The aptitude required for this field of work combined with personality, motivation and spirit translates into a broad range of potential.</p>
