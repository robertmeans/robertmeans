        ...
        /* BELOW IS COMMENTED OUT FOR LOCAL TESTING! */
...
<?php
    ...
    $subject = "Robert Means Conspectus Message";
...
?>
<form action="contact" method="post" id="contactForm" onSubmit="return validateEmail(document.forms[0].email.value);">
    <ul>
        <li>
        ...
        <li>
           <div class="g-recaptcha" data-callback="recaptchaCallback" data-sitekey="6LeoYmYUAAAAAMcfufo3DEXkw3mXZYlu9hgVB-kJ"></div>
        </li>
        <li>
